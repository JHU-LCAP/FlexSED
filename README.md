...
1. **Download** the AudioSet-Strong subset. The archive is available under [WavCaps](https://huggingface.co/datasets/cvssp/WavCaps/tree/main/Zip_files/AudioSet_SL)
